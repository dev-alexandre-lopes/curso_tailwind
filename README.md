...
* classs w-auto:        Deixa o navegador calcular e selecionar a largura do elemento;
* classs w-screen:      Utilizada para fazer um elemento abranger toda a largura da janela de visualização;
* classs w-x-*:         Seta uma largura fixa a um elemento (0 - 96);
* class w-{fraction}:   Utilizada para definir um elemento para uma largura baseada em porcentagem;